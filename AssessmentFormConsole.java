    ...
    public static int getAnswer(Question q) 
        {
            ...
            // On itère sur les choix (ici aussi on pourrait le faire dans un ordre aleatoire)
            ...
            System.out.println("SVP, ins�rez une r�ponse et appuyer sur Entrer...");
    ...
    public static void main(String[] args) 
        {
            ...
            // On itère sur chaque question pour evalue le score de l'etudiant a cette question
